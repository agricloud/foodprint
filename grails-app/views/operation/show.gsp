	...
	<body>
		...
		<div id="show-operation" class="content scaffold-show" role="main">
			...
			<ol class="property-list operation">
				...
				<g:if test="${operationInstance?.title}">
				<li class="fieldcontain">
					<span id="title-label" class="property-label"><g:message code="operation.title.label" default="Title" /></span>
					
						<span class="property-value" aria-labelledby="title-label"><g:fieldValue bean="${operationInstance}" field="title"/></span>
