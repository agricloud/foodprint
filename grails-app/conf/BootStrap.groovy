  ...
  def init = { servletContext ->
		...
		environments {
			...
			development {
				...
				def reportparam100=new  ReportParams (report:report100,param:param100,workstation:workstation1).save(failOnError: true, flush: true)
				def reportparam101=new  ReportParams (report:report100,param:param101,workstation:workstation1).save(failOnError: true, flush: true)
				def reportparam102=new  ReportParams (report:report100,param:param102,workstation:workstation2).save(failOnError: true, flush: true)
