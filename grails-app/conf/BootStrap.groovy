  	...
  	def init = { servletContext ->
		...
		environments {
			...
			development {
				...
				new Batch(name:"batch6",item:item5).save(failOnError: true, flush: true)
				new Batch(name:"batch7",item:item5).save(failOnError: true, flush: true)
				new Batch(name:"batch8",item:item5).save(failOnError: true, flush: true)
				new Batch(name:"batch9",item:item5).save(failOnError: true, flush: true)
				new Batch(name:"batch10",item:item5).save(failOnError: true, flush: true)
				new Batch(name:"batch11",item:item5).save(failOnError: true, flush: true)
				new Batch(name:"batch12",item:item5).save(failOnError: true, flush: true)
				new Batch(name:"batch13",item:item5).save(failOnError: true, flush: true)
				new Batch(name:"batch14",item:item5).save(failOnError: true, flush: true)
				new Batch(name:"batch15",item:item5).save(failOnError: true, flush: true)
				new Batch(name:"batch16",item:item5).save(failOnError: true, flush: true)
				new Batch(name:"batch17",item:item5).save(failOnError: true, flush: true)
				new Batch(name:"batch18",item:item5).save(failOnError: true, flush: true)
				new Batch(name:"batch19",item:item5).save(failOnError: true, flush: true)
				new Batch(name:"batch20",item:item5).save(failOnError: true, flush: true)
				new Batch(name:"batch21",item:item5).save(failOnError: true, flush: true)
				new Batch(name:"batch22",item:item5).save(failOnError: true, flush: true)
				new Batch(name:"batch23",item:item5).save(failOnError: true, flush: true)
				new Batch(name:"batch24",item:item5).save(failOnError: true, flush: true)
				new Batch(name:"batch25",item:item5).save(failOnError: true, flush: true)
				new Batch(name:"batch26",item:item5).save(failOnError: true, flush: true)
				new Batch(name:"batch27",item:item5).save(failOnError: true, flush: true)
				new Batch(name:"batch28",item:item5).save(failOnError: true, flush: true)
				new Batch(name:"batch29",item:item5).save(failOnError: true, flush: true)
				new Batch(name:"batch30",item:item5).save(failOnError: true, flush: true)
				new Batch(name:"batch31",item:item5).save(failOnError: true, flush: true)
				new Batch(name:"batch32",item:item5).save(failOnError: true, flush: true)
				new Batch(name:"batch33",item:item5).save(failOnError: true, flush: true)
				new Batch(name:"batch34",item:item5).save(failOnError: true, flush: true)
				new Batch(name:"batch35",item:item5).save(failOnError: true, flush: true)
				new Batch(name:"batch36",item:item5).save(failOnError: true, flush: true)
				new Batch(name:"batch37",item:item5).save(failOnError: true, flush: true)
				new Batch(name:"batch38",item:item5).save(failOnError: true, flush: true)
				new Batch(name:"batch39",item:item5).save(failOnError: true, flush: true)
				new Batch(name:"batch40",item:item5).save(failOnError: true, flush: true)
				new Batch(name:"batch41",item:item5).save(failOnError: true, flush: true)
				new Batch(name:"batch42",item:item5).save(failOnError: true, flush: true)
				new Batch(name:"batch43",item:item5).save(failOnError: true, flush: true)
				new Batch(name:"batch44",item:item5).save(failOnError: true, flush: true)
				new Batch(name:"batch45",item:item5).save(failOnError: true, flush: true)
				new Batch(name:"batch46",item:item5).save(failOnError: true, flush: true)
				new Batch(name:"batch47",item:item5).save(failOnError: true, flush: true)
				new Batch(name:"batch48",item:item5).save(failOnError: true, flush: true)
				new Batch(name:"batch49",item:item5).save(failOnError: true, flush: true)
				new Batch(name:"batch50",item:item5).save(failOnError: true, flush: true)
				new Batch(name:"batch51",item:item5).save(failOnError: true, flush: true)
				new Batch(name:"batch52",item:item5).save(failOnError: true, flush: true)
				new Batch(name:"batch53",item:item5).save(failOnError: true, flush: true)
				new Batch(name:"batch54",item:item5).save(failOnError: true, flush: true)
				new Batch(name:"batch55",item:item5).save(failOnError: true, flush: true)
				new Batch(name:"batch56",item:item5).save(failOnError: true, flush: true)
				new Batch(name:"batch57",item:item5).save(failOnError: true, flush: true)
				new Batch(name:"batch58",item:item5).save(failOnError: true, flush: true)
				new Batch(name:"batch59",item:item5).save(failOnError: true, flush: true)
				new Batch(name:"batch60",item:item5).save(failOnError: true, flush: true)
