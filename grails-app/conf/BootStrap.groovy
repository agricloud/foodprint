  ...
  def init = { servletContext ->
		...
		environments {
			...
			development {
				...
				def operation1=new Operation(name:"01",title:"operation1",description:"a").save(failOnError: true, flush: true)
				def operation2=new Operation(name:"02",title:"operation2",description:"a").save(failOnError: true, flush: true)
				
				def itemRoute1=new ItemRoute(item:item1,sequence:1,workstation:workstation1,operation:operation1).save(failOnError: true, flush: true)
				def itemRoute2=new ItemRoute(item:item1,sequence:2,workstation:workstation1,operation:operation2).save(failOnError: true, flush: true)
				def itemRoute3=new ItemRoute(item:item1,sequence:3,workstation:workstation2,operation:operation1).save(failOnError: true, flush: true)
				def itemRoute4=new ItemRoute(item:item1,sequence:4,workstation:workstation1,operation:operation2).save(failOnError: true, flush: true)
				
				def batchRoute1=new BatchRoute(batch:batch1,workstation:workstation1,operation:operation1,sequence:1).save(failOnError: true,flush: true)
				def batchRoute2=new BatchRoute(batch:batch1,workstation:workstation2,operation:operation1,sequence:2).save(failOnError: true,flush: true)
				def batchRoute3=new BatchRoute(batch:batch1,workstation:workstation2,operation:operation1,sequence:3).save(failOnError: true,flush: true)
				def batchRoute4=new BatchRoute(batch:batch1,workstation:workstation1,operation:operation1,sequence:4).save(failOnError: true,flush: true)
				def batchRoute5=new BatchRoute(batch:batch2,workstation:workstation2,operation:operation1,sequence:2).save(failOnError: true,flush: true)
				def batchRoute6=new BatchRoute(batch:batch2,workstation:workstation2,operation:operation1,sequence:3).save(failOnError: true,flush: true)
