...
Ext.ClassManager.addNameAlternateMappings({
  ...
  "foodprintTouch.store.BatchRouteDeepStore": [],
  "foodprintTouch.store.BatchRouteParamsFormStore": [],
...
Ext.ClassManager.addNameAliasMappings({
  ...
  "foodprintTouch.view.BatchRouteParamsPanel": [
    "widget.batchrouteparamspanel"
  ],
  "foodprintTouch.view.CommonBackBtn": [
    "widget.commonbackbtn"
  ],
  "foodprintTouch.view.CommonBackToolbar": [
